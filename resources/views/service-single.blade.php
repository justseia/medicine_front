            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="services-content-1 ml-15">
                        ...
                        <form action="{{ route('service.store', $service) }}" method="post">
                            @csrf
                            <input class="form-control" type="text" name="name" placeholder="Имя" style="margin-bottom: 20px;">
                            <input class="form-control" type="text" name="number" placeholder="+7(707)777-65-32" style="margin-bottom: 20px;">
                            <button class="default-btn" type="submit" style="margin-bottom: 20px;">Отправить</button>
                        </form>
                    </div>
                </div>
            </div>
